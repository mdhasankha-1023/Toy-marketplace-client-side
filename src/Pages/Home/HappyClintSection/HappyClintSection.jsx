...
const HappyClintSection = () => {
    return (
        <div data-aos="zoom-in"
            ...
            className='w-11/12 mx-auto md:w-full bg-[#F5B120] py-8 my-16'>
            <h1 className='text-center text-4xl font-bold text-white'>Our Happy Clients say</h1>
            <div className="carousel w-full">
                <div id="item1" className="carousel-item md:w-full w-3/4 mx-auto flex-col p-8">
                    ...
                    <div className='flex flex-col text-center md:me-16 justify-center items-center gap-2 text-white'>
                ...
                <div id="item2" className="carousel-item md:w-full w-3/4 mx-auto flex-col p-8">
                    <h4 className='text-center text-white font-bold mb-8'>
                        "I have been buying toys and games from this store for my kids for many many years.
                        The guys form the shop <br /> know exactly what our children need and want.
                        And they are always in trend. I totally recommend them!"
                ...
                <div id="item3" className="carousel-item md:w-full w-3/4 mx-auto flex-col p-8">
                    <h4 className='text-center text-white font-bold mb-8'>
                        "I have been buying toys and games from this store for my kids for many many years.
                        The guys form the shop <br /> know exactly what our children need and want.
                        And they are always in trend. I totally recommend them!"
